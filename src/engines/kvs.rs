...
impl KvStore {
    ...
    pub fn _set(&mut self, key: String, value: String) -> Result<()> {
    ...
    pub fn _get(&mut self, key: String) -> Result<Option<String>> {
    ...
    pub fn _remove(&mut self, key: String) -> Result<()> {
        self.count_garbage(&key);
